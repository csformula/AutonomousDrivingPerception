...
parser.add_argument("--val_path", type=str, default="./data/bdd100k_images/bdd100k/images/100k/train", help="path to trainset")
...
parser.add_argument("--weights_path", type=str, default="./checkpoints/2_try.weights", help="path to weights file")
...
# Get dataloader
dataset = Subset(ListDataset(val_path, label_path, classname_path, img_size=opt.img_size), range(65000,65010))
