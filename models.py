...
#                 self.ce_loss = self.ce_loss.cuda()
            ...
            precision = float(nCorrect / (nProposals+1e-8))
...
class Darknet(nn.Module):
    ...
    def __init__(self, config_path, img_size=416):
        ...
        self.hyperparams, self.module_list = create_modules(self.module_defs, self.img_size)
        if config_path.find('custom') != -1:
            for param in self.module_list[:75].parameters():
